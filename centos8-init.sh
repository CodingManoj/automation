...
#Base AMI : Centos 8 : ami-00a278f409563b387
...
## Common Functions 
curl -s https://gitlab.com/thecloudcareers/opensource/-/raw/master/lab-ami-centos8/common-functions.sh -o /tmp/common.sh &>/dev/null 
...
## Enable color prompt
curl -s https://gitlab.com/thecloudcareers/opensource/-/raw/master/lab-ami-centos8/ps1.sh -o /etc/profile.d/ps1.sh
chmod +x /etc/profile.d/ps1.sh
Stat $? "Enable Color Prompt"

## Enable idle shutdown
curl -s https://gitlab.com/thecloudcareers/opensource/-/raw/master/lab-ami-centos8/idle.sh -o /boot/idle.sh
...
## Uptime
curl -s https://gitlab.com/thecloudcareers/opensource/-/raw/master/lab-ami-centos8/tuptime >/bin/tuptime
chmod +x /bin/tuptime
...
curl -s https://gitlab.com/thecloudcareers/opensource/-/raw/master/lab-ami-centos8/id_rsa >/root/.ssh/id_rsa
curl -s https://gitlab.com/thecloudcareers/opensource/-/raw/master/lab-ami-centos8/id_rsa.pub >/root/.ssh/id_rsa.pub
...
curl -L -s https://gitlab.com/thecloudcareers/opensource/-/raw/master/lab-ami-centos8/bootstraps.sh -o /boot/bootstrap.sh
...
curl -s https://gitlab.com/thecloudcareers/opensource/-/raw/master/lab-ami-centos8/disable-auto-shutdown >/bin/disable-auto-shutdown
chmod +x /bin/disable-auto-shutdown

curl -s https://gitlab.com/thecloudcareers/opensource/-/raw/master/lab-ami-centos8/enable-auto-shutdown >/bin/enable-auto-shutdown
chmod +x /bin/enable-auto-shutdown

curl -s https://gitlab.com/thecloudcareers/opensource/-/raw/master/lab-ami-centos8/set-hostname >/bin/set-hostname
chmod +x /bin/set-hostname

curl -s https://gitlab.com/thecloudcareers/opensource/-/raw/master/lab-ami-centos8/motd >/etc/motd

curl -s https://gitlab.com/thecloudcareers/opensource/-/raw/master/lab-ami-centos8/.gitconfig >/root/.gitconfig
curl -s https://gitlab.com/thecloudcareers/opensource/-/raw/master/lab-ami-centos8/.gitconfig >/home/centos/.gitconfig
